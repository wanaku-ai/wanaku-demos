...
Download the jar from the [releases page](https://github.com/wanaku-ai/camel-integration-capability/releases/tag/v0.2.0):

```shell
wget https://github.com/wanaku-ai/camel-integration-capability/releases/download/v0.2.0/camel-integration-capability-main-0.2.0-jar-with-dependencies.jar
```
...
```shell
java -jar camel-integration-capability-main-0.2.0-jar-with-dependencies.jar \
